...
![GitHub Release](https://img.shields.io/github/v/release/fearlessnite345/fs-lib?style=for-the-badge)
...
:::note
Please note that FS-Lib is still under development and may receive updates that could introduce breaking changes. These changes will be clearly marked in the changelogs.
:::